...
import { setUpcomingBookings, setPastBookings, setLoading, setError } from "../../../store/slices/bookingSlice";
...
const Bookings: React.FC = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      dispatch(setError(`Failed to load bookings: ${error.message || 'Unknown error'}`));
    } finally {
      ...
      <div className="w-full max-w-4xl mx-auto px-4">
        ...
        <div className="w-full mt-4">
          ...
          <div className="flex gap-x-2 w-full h-fit">
            ...
            >
              <span className="text-lg">Upcoming ({upcomingBookings.length})</span>
            </button>
            <button
