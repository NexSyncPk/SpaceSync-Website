...
export const ORGANIZATION_STATS = (orgId: string) => `/organization/${orgId}/stats`;
export const ORGANIZATION_USERS = (orgId: string) => `/organization/${orgId}/users`;

// Organization invite management
export const ORGANIZATION_INVITE_KEY = (orgId: string) => `/organization/${orgId}/invite-key`;
export const ORGANIZATION_REGENERATE_INVITE = (orgId: string) => `/organization/${orgId}/regenerate-invite`;
...
export const ORG_ROOM_BY_ID = (orgId: string, roomId: string) => `/organization/${orgId}/rooms/${roomId}`;

// ==================== RESERVATION ROUTES ====================
// Reservation CRUD operations
export const RESERVATIONS = "/reservations";
export const RESERVATION_BY_ID = (reservationId: string) => `/reservations/${reservationId}`;
export const RESERVATION_UPDATE = (reservationId: string) => `/reservations/${reservationId}`;
export const RESERVATION_DELETE = (reservationId: string) => `/reservations/${reservationId}`;
...
export const RESERVATION_STATUS_UPDATE = (reservationId: string) => `/reservations/${reservationId}/status`;

// Room-specific reservations
export const ROOM_RESERVATIONS = (roomId: string) => `/rooms/${roomId}/reservations`;

// ==================== ADMIN ROUTES ====================
// User management (admin only)
export const ADMIN_USERS = "/admin/users";
export const ADMIN_USER_PROMOTE = (userId: string) => `/admin/users/${userId}/promote`;
export const ADMIN_USER_DEMOTE = (userId: string) => `/admin/users/${userId}/demote`;
export const ADMIN_USER_REMOVE = (userId: string) => `/admin/users/${userId}`;
export const ADMIN_USER_UPDATE_PROFILE = (userId: string) => `/admin/users/${userId}/profile`;
...
export const EXTERNAL_ATTENDEE_BY_ID = (attendeeId: string) => `/external-attendees/${attendeeId}`;
export const EXTERNAL_ATTENDEE_UPDATE = (attendeeId: string) => `/external-attendees/${attendeeId}`;
export const EXTERNAL_ATTENDEE_DELETE = (attendeeId: string) => `/external-attendees/${attendeeId}`;

// Reservation-specific external attendees
export const RESERVATION_ATTENDEES = (reservationId: string) => `/reservations/${reservationId}/attendees`;
export const RESERVATION_ATTENDEE_BY_ID = (reservationId: string, attendeeId: string) => 
